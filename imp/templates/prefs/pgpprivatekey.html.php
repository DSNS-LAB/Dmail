...
?>
    ...
    <td>
     <?php echo $email['id'] ?><input type="hidden" id="generate_realname" name="generate_realname" size="30" maxlength="60" value="<?php echo $email['id'] //$this->fullname ?>"/>
    </td>
    <td>
   ...
   <tr>
    ...
    <td>
     <?php echo $email['address'] ?><input type="hidden" id="generate_email" name="generate_email" size="30" maxlength="60" value="<?php echo $email['address'] //$this->fromaddr ?>"/>
    </td>
    <td>
...
<?php if ($this->import_pgp_private): ?>
   <input type="hidden" name="save" class="horde-default" id="import_pgp_personal" value="<?php echo _("Import Key") ?>" />
<?php endif; ?>
